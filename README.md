...
```
![](Enzymes_activ.png)
Рис. 5. Температурной нормы реакции активности ключевых метаболических ферментов у _E. verrucosus_. Линии показывают средние значения, затененные области - 95% доверительные интервалы.
