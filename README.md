...
#### Вывод по графику:
#### Анализ активности ферментов энергетического метаболизма у у Eulimnogammarus verrucosus показал, что температура около 15,6 °C является оптимумом для большинства ферментов (COX, CS, PK). 
Активность же LDH росла на протяжении всей температуры вплоть до 23,6 °C, что может свидетельствовать о важной роли анаэробного гликолиза в механизме тепловой устойчивости.
