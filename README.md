...
#### Построение графиков активности ключевых метаболических ферментов при различных температурах: лактатдегидрогеназы (LDH), цитратсинтазы (CS), цитохром-c-оксидаза (COX) и пируваткиназы (PK) у _E. verrucosus_ (Jakob et al, 2021)
```
setwd("C:/Users/epifa/Учёба/Магистратура 1 курс/Воспроизводимые исследования в биологии/RR5_data")
...
#### Построение общего графика температурной нормы реакции активности ключевых метаболических ферментов с ДИ 95%
```
# задаем рабочую директорию (где находятся файлы для анализа)
setwd("C:\\Users\\epifa\\Учёба\\Магистратура 1 курс\\Воспроизводимые исследования в биологии\\RR5_data")
...
## Повышенная экспрессия таких генов, как _ubc-45b_ (ко-шаперон _myosin II_), _smyd4_ (эпигенетическая регуляция) и _chs_ (биосинтез хитина) свидетельствует об активном стресс-ответе.
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
