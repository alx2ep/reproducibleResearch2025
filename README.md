...
#### Построение графиковмактивности ключевых метаболических ферментов при различных температурах: лактатдегидрогеназы (LDH), цитратсинтазы (CS), цитохром-c-оксидаза (COX) и пируваткиназы (PK) у _E. verrucosus_ (Jakob et al, 2021)
```
setwd("C:/Users/epifa/Учёба/Магистратура 1 курс/Воспроизводимые исследования в биологии/RR5_data")
...
## ВЫВОДЫ
## Анализ активности ферментов энергетического метаболизма у _Eulimnogammarus verrucosus_ показал, что температура около 15,6 °C является оптимумом для большинства ферментов (COX, CS, PK). Активность же LDH продолжала рости вплоть до 23,6 °C, что может свидетельствовать о важной роли анаэробного гликолиза в механизме тепловой устойчивости. Данные результаты согласуются с выводами Jakob (2021).
